  ...
  if (_action === "newUser") {
    try {
      ...
      if (existingUser) {
        ...
        const response = await fetch(`/api/users?username=${values.userName}`);
        ...
        const usersResponse2 = await fetch('/api/budgets');
        ...
        const usersResponse3 = await fetch('/api/expenses');
